...
| **Weight Decoding** | `No of Weight Digit`, `Decimal`, `Remove End Digits`, `Reverse`. | `WeightDecoder` on `ParsedWeightFrame` string payload. | Legacy Settings UI, Physical Display photo. | `WeightDecoderTests.cs` (Candidate: 0000900 -> 90.0, Baseline: 0001450 -> 1450.0). | `[PENDING]` |
